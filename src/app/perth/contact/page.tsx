...
export default function PerthContactPage() {
    ...
    <PageContainer>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 md:py-24 grid md:grid-cols-2 items-center gap-10">
          <div>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900">Contact — Perth</h1>
            <p className="mt-4 text-lg leading-relaxed text-slate-700">
              Ready to book at‑home swim lessons in Perth? Reach out and we’ll get you scheduled.
            </p>
          ...
          <div className="relative">
            <div className="w-full overflow-hidden rounded-3xl shadow-2xl ring-1 ring-slate-200 relative" style={{ aspectRatio: '4 / 3' }}>
              <NextImage src="/assets/Perth.png" alt="Perth swim lesson" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
            <div className="absolute -bottom-4 -right-4 bg-white/80 backdrop-blur rounded-2xl px-4 py-3 shadow ring-1 ring-slate-200">
              <p className="text-sm font-medium">Flexible scheduling • Home pools • Community pools</p>
            </div>
          </div>
        </div>
      </section>
